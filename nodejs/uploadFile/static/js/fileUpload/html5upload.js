    ...
    return this.each(function(){
      ...
      this.createHtml = function(){
        ...
        if(para.dragDrop){
          ...
          html += '       </div>';
          html += '     </div>';
          html += '     <div id="preview" class="upload_preview">';html += '       <div class="add_upload">';
      ...
      this.createCorePlug = function(){
        var params = {
          ...
          onSelect: function(selectFiles, allFiles) {
            ...
            self.funSetStatusInfo(FileOperation.funReturnNeedFiles());  // 显示统计信息
            var html = '', i = 0;
            // 组织预览html
            ...
            var funBindDelEvent = function(){
              if($(".file_del").length>0){
                ...
                $(".file_del").click(function() {
                  FileOperation.funDeleteFile(parseInt($(this).attr("data-index")), true);
                  return false; 
                });
              }
              ...
              if($(".file_edit").length>0){
                ...
                $(".file_edit").click(function() {
                  // 调用编辑操作
                  //FileOperation.funEditFile(parseInt($(this).attr("data-index")), true);
                  return false; 
                });
              }
            };
          ...
          onProgress: function(file, loaded, total) {
            ...
            eleProgress.is(":hidden") && eleProgress.show();
          ...
          onSuccess: function(file, response) {
            ...
            if(para.finishDel){
              ...
              $("#uploadList_" + file.index).fadeOut();
              // 重新设置统计栏信息
              self.funSetStatusInfo(FileOperation.funReturnNeedFiles());
            }
          },
        ...
        FileOperation = $.extend(FileOperation, params);
        FileOperation.init();
      };
      ...
      this.addEvent = function(){
        ...
        $(".upload_btn").bind("click", function(e){
          // 判断当前是否有文件需要上传
          if(FileOperation.funReturnNeedFiles().length > 0){
            $("#fileSubmit").click();
          }else{
            alert("请先选中文件再点击上传");
          }
