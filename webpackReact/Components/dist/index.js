...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavMenu = __webpack_require__(247);
	...
	var _saveLoadingButton = __webpack_require__(260);
	
	var _saveLoadingButton2 = _interopRequireDefault(_saveLoadingButton);
	
	var _CanvasUpload = __webpack_require__(263);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'item', id: 'saveLoading' },
							_react2.default.createElement(
								'h2',
								null,
								'(2016/08/26)React Save Loading Button'
							),
							_react2.default.createElement(_saveLoadingButton2.default, null)
						),
						_react2.default.createElement(
							'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loading = function (_React$Component) {
		...
		function Loading(props) {
			...
			var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Loading).call(this, props));
		...
		(0, _createClass3.default)(Loading, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: "zjdgx-loading circle-spinner" + (this.state.showLoading ? '' : ' hide') },
					_react2.default.createElement(
						'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SaveLoadingButton = function (_React$Component) {
		(0, _inherits3.default)(SaveLoadingButton, _React$Component);
	
		function SaveLoadingButton(props) {
			(0, _classCallCheck3.default)(this, SaveLoadingButton);
	
			var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(SaveLoadingButton).call(this, props));
		...
		(0, _createClass3.default)(SaveLoadingButton, [{
			key: 'toggleLoading',
			...
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'zjdgx-save-loading' },
					_react2.default.createElement(
						'span',
						{ className: 'zjdgx-save-loading_button', onClick: this.toggleLoading.bind(this) },
						'Save'
					),
					_react2.default.createElement(_Loading2.default, { showLoading: this.state.showLoading })
				);
			}
		}]);
		return SaveLoadingButton;
	}(_react2.default.Component);
	
	exports.default = SaveLoadingButton;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fileInput = __webpack_require__(264);
		...
		(0, _createClass3.default)(zjdgxCanvasUpload, [{
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'span',
						{ className: 'icon add', onClick: this.toggleScale.bind(this, 1) },
						'+'
					),
					_react2.default.createElement(
						'span',
						{ className: 'icon substact', onClick: this.toggleScale.bind(this, 0) },
						'-'
					),
					_react2.default.createElement(_fileInput2.default, { ref: 'imageFile', onFileSelected: this.onFileSelected.bind(this) })
				);
			}
		}]);
