...
/***/ function(module, exports, __webpack_require__) {
	...
	const Vue = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())),
			VueRouter = __webpack_require__(2),
			VueSource = __webpack_require__(3);
	...
	router.map({
		...
		'/blog': {
			name: 'blog',
			component: (resolve) => {
				!/* require */(/* empty */function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [!(function webpackMissingModule() { var e = new Error("Cannot find module \"./vue/blog.vue\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.call(this))
			}
		}
	});
